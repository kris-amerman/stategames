...
// Use same port in production (Railway), different in development
export const WS_PORT = process.env.NODE_ENV === 'production' ? PORT : (process.env.WS_PORT || 3001);
...
console.log('HTTP Server will listen on:', PORT);
