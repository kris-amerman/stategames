import { generateTerrain, loadOrGetMesh, MapSize } from "./main";
import { BiomeConfig } from "./terrain-gen/biomes";
import { ElevationConfig } from "./terrain-gen/elevations";

export function createUI(elevationConfig: ElevationConfig, biomeConfig: BiomeConfig, currentMapSize: MapSize) {
  // Create UI panel
